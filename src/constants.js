...
export const LOL_API_KEY = 'RGAPI-f2417de0-bbc0-4e70-88d9-5c13547b0781';
export const LOL_URL = {
    ...
    'CHAMPION_ICON': 'http://ddragon.leagueoflegends.com/cdn/%s/img/champion/%s.png',
    'STATIC_SPELL_ALL_DATA': 'http://ddragon.leagueoflegends.com/cdn/%s/data/ko_KR/summoner.json',
    'SPELL_ICON': 'http://ddragon.leagueoflegends.com/cdn/%s/img/spell/%s.png',
    'ITEM_ICON': 'http://ddragon.leagueoflegends.com/cdn/%s/img/item/%d.png',
};
export const LOL_API = {
    ...
    'GET_CHAMPION_MASTERIES': BASE_API_URL +
